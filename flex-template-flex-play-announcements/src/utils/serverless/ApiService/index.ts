...
export default abstract class ApiService {
  ...
  constructor() {
    ...
    // use serverless_functions_domain_flex_play_announcements from ui_attributes, or .env or set as undefined
    ...
    if (custom_data?.serverless_functions_domain_flex_play_announcements) this.serverlessDomain = custom_data.serverless_functions_domain_flex_play_announcements;
    ...
    if (!this.serverlessDomain) console.error('serverless_functions_domain_flex_play_announcements is not set in flex config or env file');
  }
